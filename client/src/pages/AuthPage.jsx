          ...
          <form onSubmit={handleAdminPass} style={{display:"flex",flexDirection:"column",gap:"16px"}}>
            ...
            <div>
              ...
              <div style={{position:"relative"}}>
                ...
                <button type="button" onClicgit remote add origin k={()=>setShowPass(p=>!p)} style={{position:"absolute",right:"14px",top:"50%",transform:"translateY(-50%)",background:"none",border:"none",cursor:"pointer",color:"rgba(255,255,255,.4)",padding:0}}>
                  {showPass
